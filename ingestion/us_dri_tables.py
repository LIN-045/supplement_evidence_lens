...
Run from the project root:
    ...
    uv run python ingestion/us_dri_tables.py
...
OUTPUT_PATH = PROCESSED_DIR / "us_dri_reference_values.jsonl"
...
def main() -> None:
    ...
    index_content = download(ODS_PAGE_URL)
    ...
    atomic_write(OUTPUT_PATH, serialise_jsonl(all_records))
    atomic_write(ERRORS_PATH, b"[]\n")

    print(f"Parsed values: {len(all_records)}")
